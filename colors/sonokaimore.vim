...
if s:configuration.style ==# 'shusia'
  let s:palette = {
        ...
        \ 'muted_grey': ['#7e8294',   '244',  'MutedGrey'],
        \ 'none':       ['NONE',      'NONE', 'NONE']
        \ }
...
call s:HL('LineNr', s:palette.muted_grey, s:palette.none)
...
"   call s:HL('Comment', s:palette.none, s:palette.red)
...
highlight! link rubyBlockParameterList Orange
